...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_,
        ...
        if (!this.field_148301_e.isShow) {
            this.field_148301_e.isShow = true;
        ...
        boolean flag1 = this.field_148301_e.magicNumber > 5;
        boolean flag2 = this.field_148301_e.magicNumber < 5;
        boolean flag3 = flag1 || flag2;
        this.field_148300_d.fontRenderer.drawString(this.field_148301_e.serverName, p_148279_2_ + 32 + 3,
                p_148279_3_ + 1, 16777215);
        List list = this.field_148300_d.fontRenderer.listFormattedStringToWidth(
                FMLClientHandler.instance().fixDescription(this.field_148301_e.serverMOTD), p_148279_4_ - 48 - 2);

        for (int l1 = 0; l1 < Math.min(list.size(), 2); ++l1) {
            this.field_148300_d.fontRenderer.drawString((String) list.get(l1), p_148279_2_ + 32 + 3,
                    p_148279_3_ + 12 + this.field_148300_d.fontRenderer.FONT_HEIGHT * l1, 8421504);
        }
        ...
        this.field_148300_d.fontRenderer.drawString(s2, p_148279_2_ + p_148279_4_ - i2 - 15 - 2, p_148279_3_ + 1,
                8421504);
        byte b0 = 0;
        String s = null;
        int j2;
        ...
        } else if (this.field_148301_e.isShow && this.field_148301_e.pingToServer != -2L) {
        ...
        Gui.func_146110_a(p_148279_2_ + p_148279_4_ - 15, p_148279_3_, (float) (b0 * 10), (float) (176 + j2 * 8), 10, 8,
                256.0F, 256.0F);
        ...
        String tooltip = FMLClientHandler.instance().enhanceServerListEntry(this, this.field_148301_e, p_148279_2_,
            ...
            label74: {
                try {
                    ...
                    logger.error("Invalid icon for server " + this.field_148301_e.serverName + " ("
                            + this.field_148301_e.serverIP + ")", exception);
                    this.field_148301_e.getIconBase64((String) null);
                } finally {
                    bytebuf.release();
                    bytebuf1.release();
                }
