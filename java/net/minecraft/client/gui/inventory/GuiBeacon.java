...
public class GuiBeacon extends GuiContainer
{
    ...
    class PowerButton extends GuiBeacon.Button
    {
        ...
        {
            super(p_i1076_2_, p_i1076_3_, p_i1076_4_, GuiContainer.inventoryBackgroundTexture, 0 + Potion.potionTypes[p_i1076_5_].getStatusIconIndex() % 8 * 18, 198 + Potion.potionTypes[p_i1076_5_].getStatusIconIndex() / 8 * 18);
