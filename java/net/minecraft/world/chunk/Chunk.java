...
public class Chunk
{
    ...
    /** 确定数据块是否在大于 0 的光照值下被照亮。*/
    public static boolean isLit;
    /**
     * 用于存储块 ID、块 MSB、天空光照贴图、块光照贴图和元数据。每个条目对应一个
     * 16x16x16 块的逻辑段，垂直堆叠。
     */
    private ExtendedBlockStorage[] storageArrays;
    /** 包含每个列所属的生物群系 ID 的 X/Z 平面上的 16x16 映射。*/
    private byte[] blockBiomeArray;
    /** 类似于 heightMap 的地图，用于跟踪降雨量的下降距离。*/
    public int[] precipitationHeightMap;
    /** 哪些列需要更新其 skylightMap。*/
    public boolean[] updateSkylightColumns;
    /** 此 Chunk 当前是否已加载到 World 中 */
    ...
    /** 此数据块中 ChunkPositions 到 TileEntities 的映射 */
    public Map<net.minecraft.world.ChunkPosition, net.minecraft.tileentity.TileEntity> chunkTileEntityMap;
    /** 包含此 Chunk 中实体的列表数组。每个 List 代表一个 16 块的子区块。*/
    public List[] entityLists;
    /** 布尔值，指示是否填充了地形。*/
    public boolean isTerrainPopulated;
    public boolean isLightPopulated;
    public boolean field_150815_m;
    /** 如果 chunk 已被修改并且需要在内部更新，则设置为 true。*/
    public boolean isModified;
    /** 此 Chunk 是否具有任何实体，因此需要在每次 tick 时保存 */
    public boolean hasEntities;
    /** 根据 World.worldTime 上次保存此块的时间 */
    public long lastSaveTime;
    /**
     * 如果为 false，则不会向客户端发送对此块的更新。此字段设置为 true，第一次使用
     * chunk 发送到客户端，并且永远不会设置为 false。
     */
    ...
    /** 包含当前的循环 relight 检查索引，并且也隐含为 relight 检查位置。*/
